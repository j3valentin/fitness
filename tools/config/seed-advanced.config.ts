  ...
  */
  ...
  constructor() {
    ...
    let additionalPackages: ExtendPackages[] = [
      {
        name: 'ng2-responsive',
        path: 'node_modules/ng2-responsive/index.js',
        packageMeta: {
          main: 'index.js',
          defaultExtension: 'js'
        }
      },
      {
        ...
        path: 'node_modules/angular2-qrcode/lib/angular2-qrcode.js',
        packageMeta: {
      ...
      },
      {
        ...
        path: 'node_modules/angular2-qrscanner/dist/index.js',
        packageMeta: {
          main: 'index.js',
          defaultExtension: 'js'
        }
      ...
      {
        name: 'qrious',
        path: 'node_modules/qrious/dist/umd/qrious.js',
        packageMeta: {
          main: 'qrious.js',
          defaultExtension: 'js'
        }
